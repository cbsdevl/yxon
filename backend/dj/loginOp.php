...
fclose($myfile);
  ...
  $sql=mysqli_query($dbconnection,"SELECT * FROM workers WHERE dj_username='$u' and dj_password='$psw'")or die(mysqli_error($dbconnection));
    ...
    while($row=mysqli_fetch_array($sql))
    {
     $_SESSION["admin_id"] = $row['dj_id'];
        ...
        <font color='red' style='font-size: 20px;'>You are entering Invalid Username and Password <br>Please enter real username and password</font>
                 <br> <br><a href='../../djreg.php'>Try Again</a>
        </center>";
        echo "<script>function red(){
